...
import { DoubleColorH1, DoubleColorTitle, Title, Subtitle, Text } from "./components/Typography";
import { LinkIcon, LinkIconPrimary, LinkIconSecondary } from "./components/Button";
	...
	return (
		...
		<Section id="about">
			<div className="relative md:flex items-start md:justify-center">
				<div className="md:pe-3 w-full md:w-2/5">
				...
				<div className="flex-1 md:ps-10 w-full md:w-3/5">
					...
					<Text>
						Hi. I’m Antari 
						<br/><br/>
						I'm a Web Developer from Bali, Indonesia. Using my experience as a UI/UX Designer, I create simple yet elegant designs to develop websites that look clean and emphasize the main content for a better user experience. 
